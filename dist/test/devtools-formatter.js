    ...
    Formatter.prototype = {
        header: function (object) {
            if (isSyntaxFragment(object))
                return ["div", {}, object.title || "Source Code"]; // JsonML.fromHTMLText(`<div style='font-weight: bold;'>${object.localName}</div>`)];
        ...
        body: function (object) {
            if (isSyntaxFragment(object)) {
                ...
                stage.appendChild(styles), stage.firstChild.appendChild(node);
...
//# sourceMappingURL=devtools-formatter.js.map